...
export default function FusionScreen({ run, onFuse, onBack }) {
  ...
  return (
    <div data-testid="fusion-screen" className="flex flex-col flex-1">
      <Header title="Cuneo DNA" sub={`Fondi due calciatori in uno · Cuneo DNA: x${cuneoCount}`} right={<Btn variant="ghost" data-testid="fusion-back-btn" onClick={onBack}>Indietro</Btn>} />
